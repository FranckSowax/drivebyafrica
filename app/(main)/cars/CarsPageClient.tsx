        ...
        <div className="bg-gradient-to-b from-[var(--surface)] to-transparent py-10 lg:py-14">
          <div className="container mx-auto px-4">
            <h1 className="text-3xl lg:text-4xl font-bold text-[var(--text-primary)] mb-2">
              <span className="text-mandarin">VÉHICULES D&apos;OCCASION</span> À IMPORTER
            </h1>
            <p className="text-[var(--text-muted)] max-w-xl">
              Achat de voitures d&apos;occasion depuis la Chine, la Corée du Sud et Dubaï.
              Estimation gratuite des frais d&apos;importation vers l&apos;Afrique.
            </p>
          </div>
        </div>
