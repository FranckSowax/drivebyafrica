...
const BRAND_ALIASES: Record<string, string[]> = {
  ...
  'geely': ['geely', 'coolray', 'azkarra', 'okavango', 'emgrand', 'xingyue', 'boyue', 'binrui'],
  'changan': ['changan', 'cs55', 'cs75', 'cs85', 'uni-k', 'uni-t', 'eado'],
  'great wall': ['great wall', 'haval', 'h6', 'h9', 'tank', 'wey', 'ora'],
  'jetour': ['jetour', 'dashing', 'x70', 'x90', 't2', 'traveller'],
  'chery': ['chery', 'tiggo', 'arrizo', 'exeed', 'omoda', 'jaecoo'],
  'gac': ['gac', 'trumpchi', 'gs4', 'gs8', 'aion', 'empow'],
  'xpeng': ['xpeng', 'p7', 'p5', 'g3', 'g6', 'g9'],
  'li auto': ['li auto', 'li', 'l7', 'l8', 'l9', 'mega'],
  'zeekr': ['zeekr', '001', '009', 'x'],
  'hongqi': ['hongqi', 'h5', 'h9', 'e-hs9', 'hs5'],
  'dongfeng': ['dongfeng', 'aeolus', 'forthing', 'm-hero'],
  'wuling': ['wuling', 'hongguang', 'mini ev', 'almaz'],
  'lynk': ['lynk', 'lynk & co', '01', '03', '05', '09'],
