    ...
    const { error } = await supabase
      ...
      .upsert(
        routes.map((route: Record<string, unknown>) => ({
          ...
          korea_cost_40ft_usd: route.korea_cost_40ft_usd || 0,
          china_cost_40ft_usd: route.china_cost_40ft_usd || 0,
          dubai_cost_40ft_usd: route.dubai_cost_40ft_usd || 0,
          korea_roro_usd: route.korea_roro_usd || 0,
          china_roro_usd: route.china_roro_usd || 0,
          dubai_roro_usd: route.dubai_roro_usd || 0,
          korea_flat_rack_usd: route.korea_flat_rack_usd || 0,
          china_flat_rack_usd: route.china_flat_rack_usd || 0,
          dubai_flat_rack_usd: route.dubai_flat_rack_usd || 0,
